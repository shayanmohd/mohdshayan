# 🚀 GitHub Pages Deployment - Next Steps for SEO
...
- ✅ Branch: `main` / `root`
- ✅ Custom domain: Add `mohdshayan.com` (if you have one)
...
## 🔗 BACKLINK STRATEGY (Do This Week)
...
2. **GitHub Profile** ✅ (Already done if you updated profile)

3. **Twitter/X**
   - Tweet: "Just launched my new portfolio! 🚀 [LINK]"
   - Add to bio
...
3. **Behavior** → What people click
4. **Conversions** → CV downloads, contact clicks
...
2. Go to Settings → Pages → Save again
