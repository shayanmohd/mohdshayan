...
<rect x="200" y="96" width="166" height="60" rx="8" class="viz-box-ink"/>
<text x="283" y="120" text-anchor="middle" class="viz-on-ink">full key in memory</text>
<text x="283" y="138" text-anchor="middle" class="viz-on-ink">the reconstruction moment</text>
<circle cx="366" cy="96" r="8" class="viz-d4"/>
<line x1="368" y1="126" x2="386" y2="126" class="viz-arrow" marker-end="url(#f1-ah)"/>
...
<text x="8" y="318" class="viz-tick">each signs with its own share</text>
...
<text x="600" y="318" text-anchor="end" class="viz-label-muted">no box holds the full key, at any point, in either round</text>
</svg>
...
<text x="230" y="168" class="viz-label-muted">only the last round needs the message</text><text x="520" y="168" class="viz-value">one</text>
